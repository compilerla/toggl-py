...
class OrganizationssubscriptionbillingApi:
    ...
    def create_billing_portal_session(self, organization_id: int, params: BillingportalPayload, **kwargs):  # noqa: E501
    ...
    def create_billing_portal_session_with_http_info(
        self, organization_id: int, params: BillingportalPayload, **kwargs
    ):  # noqa: E501
        """Create a billing portal session in the unified subscription system  # noqa: E501
