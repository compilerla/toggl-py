...
class WorkspacesreportssharedApi:
    ...
    def bulk_delete_saved_report_resource(
        self, workspace_id: int, input_data: SharedBulkDeleteInputData, **kwargs
    ) -> list[ModelsSavedReport]:  # noqa: E501
    ...
    def bulk_delete_saved_report_resource_with_http_info(
        self, workspace_id: int, input_data: SharedBulkDeleteInputData, **kwargs
    ) -> list[ModelsSavedReport]:  # noqa: E501
        """SavedReport  # noqa: E501
