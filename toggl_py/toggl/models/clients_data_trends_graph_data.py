...
class ClientsDataTrendsGraphData:
    ...
    def __init__(
        self, clients: list[ClientsReportClient] = None, _date: str = None, _configuration: Configuration = None  # noqa: E501
    ):
        """
        ClientsDataTrendsGraphData - a model defined in Swagger

        Parameters:
          clients (list[ClientsReportClient]): Optional
          _date (str): Optional
        """
    ...
    @property
    def clients(self) -> list[ClientsReportClient]:
    ...
    @clients.setter
    def clients(self, clients: list[ClientsReportClient]):
