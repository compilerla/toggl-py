...
class ClientsDataTrendsReport:
    ...
    def __init__(
        self, currency: str = None, graph: ClientsDataTrendsGraph = None, _configuration: Configuration = None  # noqa: E501
    ):
        """
        ClientsDataTrendsReport - a model defined in Swagger

        Parameters:
          currency (str): Optional
          graph (ClientsDataTrendsGraph): Optional
        """
    ...
    @property
    def graph(self) -> ClientsDataTrendsGraph:
    ...
    @graph.setter
    def graph(self, graph: ClientsDataTrendsGraph):
