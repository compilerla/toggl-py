...
class CustomerPaymentMethod:
    ...
    def __init__(
        self,
        card: CustomerPaymentMethodCard = None,
        sepa_debit: CustomerPaymentMethodSEPADebit = None,
        type: str = None,
        us_bank_account: CustomerPaymentMethodUSBankAccount = None,
        _configuration: Configuration = None,  # noqa: E501
    ):
        """
        CustomerPaymentMethod - a model defined in Swagger

        Parameters:
          card (CustomerPaymentMethodCard): Optional
          sepa_debit (CustomerPaymentMethodSEPADebit): Optional
          type (str): Optional
          us_bank_account (CustomerPaymentMethodUSBankAccount): Optional
        """
    ...
    @property
    def card(self) -> CustomerPaymentMethodCard:
    ...
    @card.setter
    def card(self, card: CustomerPaymentMethodCard):
    ...
    @property
    def sepa_debit(self) -> CustomerPaymentMethodSEPADebit:
    ...
    @sepa_debit.setter
    def sepa_debit(self, sepa_debit: CustomerPaymentMethodSEPADebit):
    ...
    @property
    def us_bank_account(self) -> CustomerPaymentMethodUSBankAccount:
    ...
    def us_bank_account(self, us_bank_account: CustomerPaymentMethodUSBankAccount):
