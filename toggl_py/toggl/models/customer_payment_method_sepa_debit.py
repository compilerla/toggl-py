...
class CustomerPaymentMethodSEPADebit:
    ...
    def __init__(self, bank_code=None, country=None, last4=None, _configuration=None):  # noqa: E501
        """CustomerPaymentMethodSEPADebit - a model defined in Swagger"""  # noqa: E501
