...
class CustomerUnifiedCustomerResponse:
    ...
    def __init__(
        ...
        state=None,
        tax_number=None,
        toggl_user_email=None,
        toggl_user_id=None,
        _configuration=None,
    ):  # noqa: E501
        """CustomerUnifiedCustomerResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def toggl_user_email(self, toggl_user_email):
    ...
    def toggl_user_id(self, toggl_user_id):
