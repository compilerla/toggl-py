...
class DtoQueryRequest:
    ...
    Attributes:
      ...
      aggregation_filters (list[DtoAggFilterRequest]) = None

      aggregations (list[DtoAggregationRequest]) = None

      attributes (list[DtoAttributeRequest]) = None

      filters (list[DtoFilterRequest]) = None

      groupings (list[DtoGroupingRequest]) = None

      limit (int) = None

      ordinations (list[DtoOrdinationRequest]) = None

      period (DtoPeriodRequest) = None

      preferences (object) = None

      transformations (list[DtoTransformationRequest]) = None

      v3_query_params (str) = None
    """
    ...
    @property
    def aggregation_filters(self) -> list[DtoAggFilterRequest]:
    ...
    def aggregation_filters(self, aggregation_filters: list[DtoAggFilterRequest]):
    ...
    @property
    def aggregations(self) -> list[DtoAggregationRequest]:
    ...
    @aggregations.setter
    def aggregations(self, aggregations: list[DtoAggregationRequest]):
    ...
    @property
    def attributes(self) -> list[DtoAttributeRequest]:
    ...
    @attributes.setter
    def attributes(self, attributes: list[DtoAttributeRequest]):
    ...
    @property
    def filters(self) -> list[DtoFilterRequest]:
    ...
    @filters.setter
    def filters(self, filters: list[DtoFilterRequest]):
    ...
    @property
    def groupings(self) -> list[DtoGroupingRequest]:
    ...
    @groupings.setter
    def groupings(self, groupings: list[DtoGroupingRequest]):
    ...
    @property
    def ordinations(self) -> list[DtoOrdinationRequest]:
    ...
    @ordinations.setter
    def ordinations(self, ordinations: list[DtoOrdinationRequest]):
    ...
    @property
    def period(self) -> DtoPeriodRequest:
    ...
    @period.setter
    def period(self, period: DtoPeriodRequest):
    ...
    @property
    def transformations(self) -> list[DtoTransformationRequest]:
    ...
    def transformations(self, transformations: list[DtoTransformationRequest]):
    ...
    def v3_query_params(self, v3_query_params: str):
