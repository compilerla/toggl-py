...
class GoalsUpdateParams:
    ...
    def __init__(
        self, archive=None, description=None, icon=None, icon_color=None, name=None, target_value=None, _configuration=None
    ):  # noqa: E501
        """GoalsUpdateParams - a model defined in Swagger"""  # noqa: E501
