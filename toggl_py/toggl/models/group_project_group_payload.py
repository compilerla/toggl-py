...
class GroupProjectGroupPayload:
    ...
    def __init__(self, group_id: int = None, project_id: int = None, _configuration: Configuration = None):  # noqa: E501
        """
        GroupProjectGroupPayload - a model defined in Swagger
