...
class HandlercalendarResponse:
    ...
    def __init__(self, fetched_events=None, _configuration=None):  # noqa: E501
        """HandlercalendarResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def fetched_events(self, fetched_events):
