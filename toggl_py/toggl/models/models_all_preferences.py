...
class ModelsAllPreferences:
    ...
    def __init__(
        self,
        activity_timeline_display_activity: bool = None,
        activity_timeline_grouping_interval: str = None,
        activity_timeline_grouping_method: str = None,
        activity_timeline_recording_level: str = None,
        activity_timeline_sync_events: bool = None,
        alpha_features: list[ModelsAlphaFeature] = None,
        automatic_tagging: bool = None,
        autotracking_enabled: bool = None,
        calendar_snap_duration: str = None,
        calendar_snap_initial_location: str = None,
        calendar_visible_hours_end: int = None,
        calendar_visible_hours_start: int = None,
        calendar_zoom_level: str = None,
        cell_swipe_actions_enabled: bool = None,
        charts_view_type: str = None,
        collapse_detailed_report_entries: bool = None,
        collapse_time_entries: bool = None,
        dashboards_view_type: str = None,
        date_format: str = None,
        decimal_separator: str = None,
        default_project_id: int = None,
        default_task_id: int = None,
        display_density: str = None,
        distinct_rates: str = None,
        duration_format: str = None,
        duration_format_on_timer_duration_field: bool = None,
        edit_popup_integration_timer: bool = None,
        extension_send_error_reports: bool = None,
        extension_send_usage_statistics: bool = None,
        first_seen_business_promo: int = None,
        focus_app_on_time_entry_started: bool = None,
        focus_app_on_time_entry_stopped: bool = None,
        haptic_feedback_enabled: bool = None,
        hide_keyboard_shortcut: bool = None,
        idle_detection_enabled: bool = None,
        idle_detection_interval_in_minutes: int = None,
        inactivity_behavior: str = None,
        is_summary_total_view_visible: bool = None,
        keep_mini_timer_on_top: bool = None,
        keep_window_on_top: bool = None,
        keyboard_increment_timer_page: int = None,
        keyboard_shortcuts_enabled: bool = None,
        macos_auto_tracking_rules: ModelsMacOSAutoTrackingRules = None,
        macos_show_hide_toggl_keyboard_shortcut: ModelsKeyboardShortcut = None,
        macos_stop_continue_keyboard_shortcut: ModelsKeyboardShortcut = None,
        manual_entry_mode: str = None,
        manual_mode: bool = None,
        manual_mode_overlay_seen: bool = None,
        modify_on_start_time_change: str = None,
        offline_mode: str = None,
        pg_time_zone_name: str = None,
        pomodoro_auto_start_break: bool = None,
        pomodoro_auto_start_focus: bool = None,
        pomodoro_break_interval_in_minutes: int = None,
        pomodoro_break_project_id: int = None,
        pomodoro_break_start_sound_enabled: bool = None,
        pomodoro_break_tag_id: int = None,
        pomodoro_countdown_timer: bool = None,
        pomodoro_enabled: bool = None,
        pomodoro_focus_interval_in_minutes: int = None,
        pomodoro_focus_sound: str = None,
        pomodoro_global_sound_enabled: bool = None,
        pomodoro_interval_end_sound: bool = None,
        pomodoro_interval_end_volume: int = None,
        pomodoro_longer_break_duration_in_minutes: int = None,
        pomodoro_prevent_screen_lock: bool = None,
        pomodoro_rounds_before_longer_break: int = None,
        pomodoro_session_start_sound_enabled: bool = None,
        pomodoro_show_notifications: bool = None,
        pomodoro_stop_timer_at_interval_end: bool = None,
        pomodoro_track_breaks_as_time_entries: bool = None,
        project_dashboard_activity_mode: str = None,
        project_shortcut_enabled: bool = None,
        record_timeline: bool = None,
        remember_last_project: str = None,
        reminder_days: str = None,
        reminder_enabled: bool = None,
        reminder_interval_in_minutes: int = None,
        reminder_period: str = None,
        reminder_snoozing_in_minutes: int = None,
        report_rounding: bool = None,
        report_rounding_direction: str = None,
        report_rounding_step_in_minutes: int = None,
        reports_hide_weekends: bool = None,
        running_entry_warning: str = None,
        running_timer_notification_enabled: bool = None,
        seen_follow_modal: bool = None,
        seen_footer_popup: bool = None,
        seen_project_dashboard_overlay: bool = None,
        seen_toggl_button_modal: bool = None,
        send_product_emails: bool = None,
        send_timer_notifications: bool = None,
        send_weekly_report: bool = None,
        show_time_in_title: bool = None,
        show_all_entries: bool = None,
        show_changelog: bool = None,
        show_description_in_menu_bar: bool = None,
        show_dock_icon: bool = None,
        show_events_in_calendar: bool = None,
        show_project_in_menu_bar: bool = None,
        show_qr_scanner: bool = None,
        show_seconds_in_menu_bar: bool = None,
        show_timeline_in_day_view: bool = None,
        show_timer_in_menu_bar: bool = None,
        show_today_total_in_menu_bar: bool = None,
        show_total_billable_hours: bool = None,
        show_weekend_on_timer_page: bool = None,
        show_workouts_in_calendar: bool = None,
        sleep_behaviour: str = None,
        smart_alerts_option: str = None,
        snowball_report_rounding: str = None,
        stack_times_on_manual_mode_after: str = None,
        start_automatically: bool = None,
        start_shortcut_mode: str = None,
        stop_at_specific_time: bool = None,
        stop_automatically: bool = None,
        stop_entry_on_shutdown: bool = None,
        stop_specified_time: str = None,
        stopped_timer_notification_enabled: bool = None,
        suggestions_enabled: bool = None,
        summary_report_amounts: str = None,
        summary_report_distinct_rates: bool = None,
        summary_report_grouping: str = None,
        summary_report_sort_asc: bool = None,
        summary_report_sort_field: str = None,
        summary_report_sub_grouping: str = None,
        summary_total_mode: str = None,
        tags_shortcut_enabled: bool = None,
        theme: str = None,
        time_entry_display_mode: str = None,
        time_entry_ghost_suggestions_enabled: bool = None,
        time_entry_start_stop_input_mode: str = None,
        timeofday_format: str = None,
        timer_view: str = None,
        timer_view_mobile: str = None,
        to_s_accept_needed: bool = None,
        use_mini_timer: bool = None,
        visible_footer: str = None,
        web_time_entry_started: bool = None,
        web_time_entry_stopped: bool = None,
        weekly_report_grouping: str = None,
        weekly_report_value_to_show: str = None,
        windows_auto_tracking_rules: ModelsWindowsAutoTrackingRules = None,
        windows_show_hide_toggl_keyboard_shortcut: ModelsKeyboardShortcut = None,
        windows_stop_continue_keyboard_shortcut: ModelsKeyboardShortcut = None,
        windows_stop_start_keyboard_shortcut: ModelsKeyboardShortcut = None,
        windows_theme: str = None,
        workout_default_project_id: int = None,
        _configuration: Configuration = None,  # noqa: E501
    ):
        """
        ModelsAllPreferences - a model defined in Swagger
        ...
        Parameters:
          ...
          alpha_features (list[ModelsAlphaFeature]): Optional
          ...
          collapse_detailed_report_entries (bool): Optional
          collapse_time_entries (bool): Optional
          ...
          display_density (str): Optional
          distinct_rates (str): Optional
          ...
          first_seen_business_promo (int): Optional
          ...
          hide_keyboard_shortcut (bool): Optional
          ...
          keyboard_shortcuts_enabled (bool): Optional
          macos_auto_tracking_rules (ModelsMacOSAutoTrackingRules): Optional
          macos_show_hide_toggl_keyboard_shortcut (ModelsKeyboardShortcut): Optional
          macos_stop_continue_keyboard_shortcut (ModelsKeyboardShortcut): Optional
          manual_entry_mode (str): Optional
          manual_mode (bool): Optional
          manual_mode_overlay_seen (bool): Optional
          modify_on_start_time_change (str): Optional
          offline_mode (str): Optional
          ...
          project_dashboard_activity_mode (str): Optional
          ...
          report_rounding (bool): Optional
          report_rounding_direction (str): Optional
          report_rounding_step_in_minutes (int): Optional
          reports_hide_weekends (bool): Optional
          running_entry_warning (str): Optional
          running_timer_notification_enabled (bool): Optional
          seen_follow_modal (bool): Optional
          seen_footer_popup (bool): Optional
          seen_project_dashboard_overlay (bool): Optional
          seen_toggl_button_modal (bool): Optional
          send_product_emails (bool): Optional
          send_timer_notifications (bool): Optional
          send_weekly_report (bool): Optional
          show_time_in_title (bool): Optional
          ...
          summary_report_amounts (str): Optional
          summary_report_distinct_rates (bool): Optional
          summary_report_grouping (str): Optional
          summary_report_sort_asc (bool): Optional
          summary_report_sort_field (str): Optional
          summary_report_sub_grouping (str): Optional
          ...
          timer_view (str): Optional
          timer_view_mobile (str): Optional
          to_s_accept_needed (bool): Optional
          use_mini_timer (bool): Optional
          visible_footer (str): Optional
          web_time_entry_started (bool): Optional
          web_time_entry_stopped (bool): Optional
          weekly_report_grouping (str): Optional
          weekly_report_value_to_show (str): Optional
          windows_auto_tracking_rules (ModelsWindowsAutoTrackingRules): Optional
          windows_show_hide_toggl_keyboard_shortcut (ModelsKeyboardShortcut): Optional
          windows_stop_continue_keyboard_shortcut (ModelsKeyboardShortcut): Optional
          windows_stop_start_keyboard_shortcut (ModelsKeyboardShortcut): Optional
    ...
    @property
    def activity_timeline_display_activity(self) -> bool:
    ...
    def activity_timeline_display_activity(self, activity_timeline_display_activity: bool):
    ...
    @property
    def activity_timeline_grouping_interval(self) -> str:
    ...
    def activity_timeline_grouping_interval(self, activity_timeline_grouping_interval: str):
    ...
    @property
    def activity_timeline_grouping_method(self) -> str:
    ...
    def activity_timeline_grouping_method(self, activity_timeline_grouping_method: str):
    ...
    @property
    def activity_timeline_recording_level(self) -> str:
    ...
    def activity_timeline_recording_level(self, activity_timeline_recording_level: str):
    ...
    @property
    def activity_timeline_sync_events(self) -> bool:
    ...
    def activity_timeline_sync_events(self, activity_timeline_sync_events: bool):
    ...
    @property
    def alpha_features(self) -> list[ModelsAlphaFeature]:
    ...
    def alpha_features(self, alpha_features: list[ModelsAlphaFeature]):
    ...
    @property
    def automatic_tagging(self) -> bool:
    ...
    def automatic_tagging(self, automatic_tagging: bool):
    ...
    @property
    def autotracking_enabled(self) -> bool:
    ...
    def autotracking_enabled(self, autotracking_enabled: bool):
    ...
    @property
    def calendar_snap_duration(self) -> str:
    ...
    def calendar_snap_duration(self, calendar_snap_duration: str):
    ...
    @property
    def calendar_snap_initial_location(self) -> str:
    ...
    def calendar_snap_initial_location(self, calendar_snap_initial_location: str):
    ...
    @property
    def calendar_visible_hours_end(self) -> int:
    ...
    def calendar_visible_hours_end(self, calendar_visible_hours_end: int):
    ...
    @property
    def calendar_visible_hours_start(self) -> int:
    ...
    def calendar_visible_hours_start(self, calendar_visible_hours_start: int):
    ...
    @property
    def calendar_zoom_level(self) -> str:
    ...
    def calendar_zoom_level(self, calendar_zoom_level: str):
    ...
    @property
    def cell_swipe_actions_enabled(self) -> bool:
    ...
    def cell_swipe_actions_enabled(self, cell_swipe_actions_enabled: bool):
    ...
    def charts_view_type(self, charts_view_type: str):
    ...
    @property
    def collapse_detailed_report_entries(self) -> bool:
    ...
    def collapse_detailed_report_entries(self, collapse_detailed_report_entries: bool):
    ...
    @property
    def collapse_time_entries(self) -> bool:
    ...
    def collapse_time_entries(self, collapse_time_entries: bool):
    ...
    @property
    def dashboards_view_type(self) -> str:
    ...
    def dashboards_view_type(self, dashboards_view_type: str):
    ...
    def decimal_separator(self, decimal_separator: str):
    ...
    def default_task_id(self, default_task_id: int):
    ...
    def display_density(self, display_density: str):
    ...
    def distinct_rates(self, distinct_rates: str):
    ...
    @property
    def duration_format_on_timer_duration_field(self) -> bool:
    ...
    def duration_format_on_timer_duration_field(self, duration_format_on_timer_duration_field: bool):
    ...
    @property
    def edit_popup_integration_timer(self) -> bool:
    ...
    def edit_popup_integration_timer(self, edit_popup_integration_timer: bool):
    ...
    @property
    def extension_send_error_reports(self) -> bool:
    ...
    def extension_send_error_reports(self, extension_send_error_reports: bool):
    ...
    @property
    def extension_send_usage_statistics(self) -> bool:
    ...
    def extension_send_usage_statistics(self, extension_send_usage_statistics: bool):
    ...
    @property
    def first_seen_business_promo(self) -> int:
    ...
    def first_seen_business_promo(self, first_seen_business_promo: int):
    ...
    @property
    def focus_app_on_time_entry_started(self) -> bool:
    ...
    def focus_app_on_time_entry_started(self, focus_app_on_time_entry_started: bool):
    ...
    @property
    def focus_app_on_time_entry_stopped(self) -> bool:
    ...
    def focus_app_on_time_entry_stopped(self, focus_app_on_time_entry_stopped: bool):
    ...
    @property
    def haptic_feedback_enabled(self) -> bool:
    ...
    def haptic_feedback_enabled(self, haptic_feedback_enabled: bool):
    ...
    @property
    def hide_keyboard_shortcut(self) -> bool:
    ...
    def hide_keyboard_shortcut(self, hide_keyboard_shortcut: bool):
    ...
    def idle_detection_enabled(self, idle_detection_enabled: bool):
    ...
    @property
    def idle_detection_interval_in_minutes(self) -> int:
    ...
    def idle_detection_interval_in_minutes(self, idle_detection_interval_in_minutes: int):
    ...
    @property
    def inactivity_behavior(self) -> str:
    ...
    def inactivity_behavior(self, inactivity_behavior: str):
    ...
    @property
    def is_summary_total_view_visible(self) -> bool:
    ...
    def is_summary_total_view_visible(self, is_summary_total_view_visible: bool):
    ...
    @property
    def keep_mini_timer_on_top(self) -> bool:
    ...
    def keep_mini_timer_on_top(self, keep_mini_timer_on_top: bool):
    ...
    @property
    def keep_window_on_top(self) -> bool:
    ...
    def keep_window_on_top(self, keep_window_on_top: bool):
    ...
    @property
    def keyboard_increment_timer_page(self) -> int:
    ...
    def keyboard_increment_timer_page(self, keyboard_increment_timer_page: int):
    ...
    def keyboard_shortcuts_enabled(self, keyboard_shortcuts_enabled: bool):
    ...
    @property
    def macos_auto_tracking_rules(self) -> ModelsMacOSAutoTrackingRules:
    ...
    def macos_auto_tracking_rules(self, macos_auto_tracking_rules: ModelsMacOSAutoTrackingRules):
    ...
    @property
    def macos_show_hide_toggl_keyboard_shortcut(self) -> ModelsKeyboardShortcut:
    ...
    def macos_show_hide_toggl_keyboard_shortcut(self, macos_show_hide_toggl_keyboard_shortcut: ModelsKeyboardShortcut):
    ...
    @property
    def macos_stop_continue_keyboard_shortcut(self) -> ModelsKeyboardShortcut:
    ...
    def macos_stop_continue_keyboard_shortcut(self, macos_stop_continue_keyboard_shortcut: ModelsKeyboardShortcut):
    ...
    @property
    def manual_entry_mode(self) -> str:
    ...
    def manual_entry_mode(self, manual_entry_mode: str):
    ...
    @manual_mode.setter
    def manual_mode(self, manual_mode: bool):
    ...
    @property
    def manual_mode_overlay_seen(self) -> bool:
    ...
    def manual_mode_overlay_seen(self, manual_mode_overlay_seen: bool):
    ...
    @property
    def modify_on_start_time_change(self) -> str:
    ...
    def modify_on_start_time_change(self, modify_on_start_time_change: str):
    ...
    @offline_mode.setter
    def offline_mode(self, offline_mode: str):
    ...
    @property
    def pg_time_zone_name(self) -> str:
    ...
    def pg_time_zone_name(self, pg_time_zone_name: str):
    ...
    @property
    def pomodoro_auto_start_break(self) -> bool:
    ...
    def pomodoro_auto_start_break(self, pomodoro_auto_start_break: bool):
    ...
    @property
    def pomodoro_auto_start_focus(self) -> bool:
    ...
    def pomodoro_auto_start_focus(self, pomodoro_auto_start_focus: bool):
    ...
    @property
    def pomodoro_break_interval_in_minutes(self) -> int:
    ...
    def pomodoro_break_interval_in_minutes(self, pomodoro_break_interval_in_minutes: int):
    ...
    @property
    def pomodoro_break_project_id(self) -> int:
    ...
    def pomodoro_break_project_id(self, pomodoro_break_project_id: int):
    ...
    @property
    def pomodoro_break_start_sound_enabled(self) -> bool:
    ...
    def pomodoro_break_start_sound_enabled(self, pomodoro_break_start_sound_enabled: bool):
    ...
    @property
    def pomodoro_break_tag_id(self) -> int:
    ...
    def pomodoro_break_tag_id(self, pomodoro_break_tag_id: int):
    ...
    @property
    def pomodoro_countdown_timer(self) -> bool:
    ...
    def pomodoro_countdown_timer(self, pomodoro_countdown_timer: bool):
    ...
    @property
    def pomodoro_enabled(self) -> bool:
    ...
    def pomodoro_enabled(self, pomodoro_enabled: bool):
    ...
    @property
    def pomodoro_focus_interval_in_minutes(self) -> int:
    ...
    def pomodoro_focus_interval_in_minutes(self, pomodoro_focus_interval_in_minutes: int):
    ...
    @property
    def pomodoro_focus_sound(self) -> str:
    ...
    def pomodoro_focus_sound(self, pomodoro_focus_sound: str):
    ...
    @property
    def pomodoro_global_sound_enabled(self) -> bool:
    ...
    def pomodoro_global_sound_enabled(self, pomodoro_global_sound_enabled: bool):
    ...
    @property
    def pomodoro_interval_end_sound(self) -> bool:
    ...
    def pomodoro_interval_end_sound(self, pomodoro_interval_end_sound: bool):
    ...
    @property
    def pomodoro_interval_end_volume(self) -> int:
    ...
    def pomodoro_interval_end_volume(self, pomodoro_interval_end_volume: int):
    ...
    @property
    def pomodoro_longer_break_duration_in_minutes(self) -> int:
    ...
    def pomodoro_longer_break_duration_in_minutes(self, pomodoro_longer_break_duration_in_minutes: int):
    ...
    @property
    def pomodoro_prevent_screen_lock(self) -> bool:
    ...
    def pomodoro_prevent_screen_lock(self, pomodoro_prevent_screen_lock: bool):
    ...
    @property
    def pomodoro_rounds_before_longer_break(self) -> int:
    ...
    def pomodoro_rounds_before_longer_break(self, pomodoro_rounds_before_longer_break: int):
    ...
    @property
    def pomodoro_session_start_sound_enabled(self) -> bool:
    ...
    def pomodoro_session_start_sound_enabled(self, pomodoro_session_start_sound_enabled: bool):
    ...
    @property
    def pomodoro_show_notifications(self) -> bool:
    ...
    def pomodoro_show_notifications(self, pomodoro_show_notifications: bool):
    ...
    @property
    def pomodoro_stop_timer_at_interval_end(self) -> bool:
    ...
    def pomodoro_stop_timer_at_interval_end(self, pomodoro_stop_timer_at_interval_end: bool):
    ...
    @property
    def pomodoro_track_breaks_as_time_entries(self) -> bool:
    ...
    def pomodoro_track_breaks_as_time_entries(self, pomodoro_track_breaks_as_time_entries: bool):
    ...
    @property
    def project_dashboard_activity_mode(self) -> str:
    ...
    def project_dashboard_activity_mode(self, project_dashboard_activity_mode: str):
    ...
    @property
    def project_shortcut_enabled(self) -> bool:
    ...
    def project_shortcut_enabled(self, project_shortcut_enabled: bool):
    ...
    @property
    def remember_last_project(self) -> str:
    ...
    def remember_last_project(self, remember_last_project: str):
    ...
    def reminder_days(self, reminder_days: str):
    ...
    def reminder_enabled(self, reminder_enabled: bool):
    ...
    @property
    def reminder_interval_in_minutes(self) -> int:
    ...
    def reminder_interval_in_minutes(self, reminder_interval_in_minutes: int):
    ...
    def reminder_period(self, reminder_period: str):
    ...
    @property
    def reminder_snoozing_in_minutes(self) -> int:
    ...
    def reminder_snoozing_in_minutes(self, reminder_snoozing_in_minutes: int):
    ...
    def report_rounding(self, report_rounding: bool):
    ...
    @property
    def report_rounding_direction(self) -> str:
    ...
    def report_rounding_direction(self, report_rounding_direction: str):
    ...
    @property
    def report_rounding_step_in_minutes(self) -> int:
    ...
    def report_rounding_step_in_minutes(self, report_rounding_step_in_minutes: int):
    ...
    @property
    def reports_hide_weekends(self) -> bool:
    ...
    def reports_hide_weekends(self, reports_hide_weekends: bool):
    ...
    @property
    def running_entry_warning(self) -> str:
    ...
    def running_entry_warning(self, running_entry_warning: str):
    ...
    @property
    def running_timer_notification_enabled(self) -> bool:
    ...
    def running_timer_notification_enabled(self, running_timer_notification_enabled: bool):
    ...
    @property
    def seen_follow_modal(self) -> bool:
    ...
    def seen_follow_modal(self, seen_follow_modal: bool):
    ...
    @property
    def seen_footer_popup(self) -> bool:
    ...
    def seen_footer_popup(self, seen_footer_popup: bool):
    ...
    @property
    def seen_project_dashboard_overlay(self) -> bool:
    ...
    def seen_project_dashboard_overlay(self, seen_project_dashboard_overlay: bool):
    ...
    @property
    def seen_toggl_button_modal(self) -> bool:
    ...
    def seen_toggl_button_modal(self, seen_toggl_button_modal: bool):
    ...
    @property
    def send_product_emails(self) -> bool:
    ...
    def send_product_emails(self, send_product_emails: bool):
    ...
    @property
    def send_timer_notifications(self) -> bool:
    ...
    def send_timer_notifications(self, send_timer_notifications: bool):
    ...
    def send_weekly_report(self, send_weekly_report: bool):
    ...
    @property
    def show_time_in_title(self) -> bool:
    ...
    def show_time_in_title(self, show_time_in_title: bool):
    ...
    @property
    def show_all_entries(self) -> bool:
    ...
    def show_all_entries(self, show_all_entries: bool):
    ...
    def show_changelog(self, show_changelog: bool):
    ...
    @property
    def show_description_in_menu_bar(self) -> bool:
    ...
    def show_description_in_menu_bar(self, show_description_in_menu_bar: bool):
    ...
    def show_dock_icon(self, show_dock_icon: bool):
    ...
    @property
    def show_events_in_calendar(self) -> bool:
    ...
    def show_events_in_calendar(self, show_events_in_calendar: bool):
    ...
    @property
    def show_project_in_menu_bar(self) -> bool:
    ...
    def show_project_in_menu_bar(self, show_project_in_menu_bar: bool):
    ...
    def show_qr_scanner(self, show_qr_scanner: bool):
    ...
    @property
    def show_seconds_in_menu_bar(self) -> bool:
    ...
    def show_seconds_in_menu_bar(self, show_seconds_in_menu_bar: bool):
    ...
    @property
    def show_timeline_in_day_view(self) -> bool:
    ...
    def show_timeline_in_day_view(self, show_timeline_in_day_view: bool):
    ...
    @property
    def show_timer_in_menu_bar(self) -> bool:
    ...
    def show_timer_in_menu_bar(self, show_timer_in_menu_bar: bool):
    ...
    @property
    def show_today_total_in_menu_bar(self) -> bool:
    ...
    def show_today_total_in_menu_bar(self, show_today_total_in_menu_bar: bool):
    ...
    @property
    def show_total_billable_hours(self) -> bool:
    ...
    def show_total_billable_hours(self, show_total_billable_hours: bool):
    ...
    @property
    def show_weekend_on_timer_page(self) -> bool:
    ...
    def show_weekend_on_timer_page(self, show_weekend_on_timer_page: bool):
    ...
    @property
    def show_workouts_in_calendar(self) -> bool:
    ...
    def show_workouts_in_calendar(self, show_workouts_in_calendar: bool):
    ...
    def sleep_behaviour(self, sleep_behaviour: str):
    ...
    @property
    def smart_alerts_option(self) -> str:
    ...
    def smart_alerts_option(self, smart_alerts_option: str):
    ...
    @property
    def snowball_report_rounding(self) -> str:
    ...
    def snowball_report_rounding(self, snowball_report_rounding: str):
    ...
    @property
    def stack_times_on_manual_mode_after(self) -> str:
    ...
    def stack_times_on_manual_mode_after(self, stack_times_on_manual_mode_after: str):
    ...
    def start_automatically(self, start_automatically: bool):
    ...
    @property
    def start_shortcut_mode(self) -> str:
    ...
    def start_shortcut_mode(self, start_shortcut_mode: str):
    ...
    @property
    def stop_at_specific_time(self) -> bool:
    ...
    def stop_at_specific_time(self, stop_at_specific_time: bool):
    ...
    @property
    def stop_automatically(self) -> bool:
    ...
    def stop_automatically(self, stop_automatically: bool):
    ...
    @property
    def stop_entry_on_shutdown(self) -> bool:
    ...
    def stop_entry_on_shutdown(self, stop_entry_on_shutdown: bool):
    ...
    @property
    def stop_specified_time(self) -> str:
    ...
    def stop_specified_time(self, stop_specified_time: str):
    ...
    @property
    def stopped_timer_notification_enabled(self) -> bool:
    ...
    def stopped_timer_notification_enabled(self, stopped_timer_notification_enabled: bool):
    ...
    @property
    def summary_report_amounts(self) -> str:
    ...
    def summary_report_amounts(self, summary_report_amounts: str):
    ...
    @property
    def summary_report_distinct_rates(self) -> bool:
    ...
    def summary_report_distinct_rates(self, summary_report_distinct_rates: bool):
    ...
    @property
    def summary_report_grouping(self) -> str:
    ...
    def summary_report_grouping(self, summary_report_grouping: str):
    ...
    @property
    def summary_report_sort_asc(self) -> bool:
    ...
    def summary_report_sort_asc(self, summary_report_sort_asc: bool):
    ...
    @property
    def summary_report_sort_field(self) -> str:
    ...
    def summary_report_sort_field(self, summary_report_sort_field: str):
    ...
    @property
    def summary_report_sub_grouping(self) -> str:
    ...
    def summary_report_sub_grouping(self, summary_report_sub_grouping: str):
    ...
    @property
    def summary_total_mode(self) -> str:
    ...
    def summary_total_mode(self, summary_total_mode: str):
    ...
    @property
    def tags_shortcut_enabled(self) -> bool:
    ...
    def tags_shortcut_enabled(self, tags_shortcut_enabled: bool):
    ...
    @property
    def time_entry_display_mode(self) -> str:
    ...
    def time_entry_display_mode(self, time_entry_display_mode: str):
    ...
    @property
    def time_entry_ghost_suggestions_enabled(self) -> bool:
    ...
    def time_entry_ghost_suggestions_enabled(self, time_entry_ghost_suggestions_enabled: bool):
    ...
    @property
    def time_entry_start_stop_input_mode(self) -> str:
    ...
    def time_entry_start_stop_input_mode(self, time_entry_start_stop_input_mode: str):
    ...
    def timeofday_format(self, timeofday_format: str):
    ...
    @timer_view.setter
    def timer_view(self, timer_view: str):
    ...
    @property
    def timer_view_mobile(self) -> str:
    ...
    def timer_view_mobile(self, timer_view_mobile: str):
    ...
    @property
    def to_s_accept_needed(self) -> bool:
    ...
    def to_s_accept_needed(self, to_s_accept_needed: bool):
    ...
    def use_mini_timer(self, use_mini_timer: bool):
    ...
    def visible_footer(self, visible_footer: str):
    ...
    @property
    def web_time_entry_started(self) -> bool:
    ...
    def web_time_entry_started(self, web_time_entry_started: bool):
    ...
    @property
    def web_time_entry_stopped(self) -> bool:
    ...
    def web_time_entry_stopped(self, web_time_entry_stopped: bool):
    ...
    @property
    def weekly_report_grouping(self) -> str:
    ...
    def weekly_report_grouping(self, weekly_report_grouping: str):
    ...
    @property
    def weekly_report_value_to_show(self) -> str:
    ...
    def weekly_report_value_to_show(self, weekly_report_value_to_show: str):
    ...
    @property
    def windows_auto_tracking_rules(self) -> ModelsWindowsAutoTrackingRules:
    ...
    def windows_auto_tracking_rules(self, windows_auto_tracking_rules: ModelsWindowsAutoTrackingRules):
    ...
    @property
    def windows_show_hide_toggl_keyboard_shortcut(self) -> ModelsKeyboardShortcut:
    ...
    def windows_show_hide_toggl_keyboard_shortcut(self, windows_show_hide_toggl_keyboard_shortcut: ModelsKeyboardShortcut):
    ...
    @property
    def windows_stop_continue_keyboard_shortcut(self) -> ModelsKeyboardShortcut:
    ...
    def windows_stop_continue_keyboard_shortcut(self, windows_stop_continue_keyboard_shortcut: ModelsKeyboardShortcut):
    ...
    @property
    def windows_stop_start_keyboard_shortcut(self) -> ModelsKeyboardShortcut:
    ...
    def windows_stop_start_keyboard_shortcut(self, windows_stop_start_keyboard_shortcut: ModelsKeyboardShortcut):
    ...
    def windows_theme(self, windows_theme: str):
    ...
    @property
    def workout_default_project_id(self) -> int:
    ...
    def workout_default_project_id(self, workout_default_project_id: int):
