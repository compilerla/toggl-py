...
class ModelsAlphaFeature:
    ...
    def __init__(
        self, alpha_feature_id=None, code=None, deleted_at=None, description=None, enabled=None, _configuration=None
    ):  # noqa: E501
        """ModelsAlphaFeature - a model defined in Swagger"""  # noqa: E501
    ...
    def alpha_feature_id(self, alpha_feature_id):
