...
class ModelsCountry:
    ...
    def __init__(
        ...
        id: int = None,
        name: str = None,
        vat_applicable: bool = None,
        vat_percentage: float = None,
        vat_regex: str = None,
        _configuration: Configuration = None,  # noqa: E501
    ):
        """
        ModelsCountry - a model defined in Swagger
    ...
    @property
    def default_currency_id(self) -> int:
    ...
    def default_currency_id(self, default_currency_id: int):
    ...
    def vat_applicable(self, vat_applicable: bool):
    ...
    def vat_percentage(self, vat_percentage: float):
    ...
    @vat_regex.setter
    def vat_regex(self, vat_regex: str):
