...
class ModelsGoalStats:
    ...
    def __init__(
        self, longest_streak=None, status=None, successful_cadences=None, total_cadences=None, _configuration=None
    ):  # noqa: E501
        """ModelsGoalStats - a model defined in Swagger"""  # noqa: E501
    ...
    def longest_streak(self, longest_streak):
    ...
    def successful_cadences(self, successful_cadences):
    ...
    def total_cadences(self, total_cadences):
