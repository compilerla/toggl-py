...
class ModelsKeyboardShortcut:
    ...
    def __init__(self, key: int = None, modifiers: int = None, _configuration: Configuration = None):  # noqa: E501
        """
        ModelsKeyboardShortcut - a model defined in Swagger
    ...
    @modifiers.setter
    def modifiers(self, modifiers: int):
