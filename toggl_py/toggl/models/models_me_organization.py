...
class ModelsMeOrganization:
    ...
    def __init__(
        ...
        created_at=None,
        id=None,
        is_multi_workspace_enabled=None,
        is_unified=None,
        ...
        """ModelsMeOrganization - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def is_multi_workspace_enabled(self):
    ...
    def is_multi_workspace_enabled(self, is_multi_workspace_enabled):
    ...
    def max_workspaces(self, max_workspaces):
    ...
    @trial_info.setter
    def trial_info(self, trial_info):
