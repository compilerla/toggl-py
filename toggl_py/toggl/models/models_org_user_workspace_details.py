...
class ModelsOrgUserWorkspaceDetails:
    ...
    def __init__(
        ...
        workspace_user_id: int = None,
        _configuration: Configuration = None,  # noqa: E501
    ):
        """
        ModelsOrgUserWorkspaceDetails - a model defined in Swagger
    ...
    def working_hours(self, working_hours: float):
    ...
    @property
    def workspace_user_id(self) -> int:
    ...
    def workspace_user_id(self, workspace_user_id: int):
