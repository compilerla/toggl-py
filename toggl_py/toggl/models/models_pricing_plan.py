...
class ModelsPricingPlan:
    ...
    def __init__(
        ...
        """
        ModelsPricingPlan - a model defined in Swagger

        Parameters:
          amount_in_cents (int): Optional
          currency (str): Optional
          period (int): Optional
          plan (ModelsPlan): Optional
    ...
    def amount_in_cents(self, amount_in_cents: int):
