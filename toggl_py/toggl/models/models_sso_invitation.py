...
class ModelsSSOInvitation:
    ...
    def __init__(
        ...
        """ModelsSSOInvitation - a model defined in Swagger"""  # noqa: E501
    ...
    def accounts_signup_url(self, accounts_signup_url):
