...
class ModelsTimeEntryConstraints:
    ...
    def __init__(
        ...
        project_present: bool = None,
        tag_present: bool = None,
        task_present: bool = None,
        time_entry_constraints_enabled: bool = None,
        _configuration: Configuration = None,  # noqa: E501
    ):
        """
        ModelsTimeEntryConstraints - a model defined in Swagger
    ...
    def description_present(self, description_present: bool):
    ...
    def project_present(self, project_present: bool):
    ...
    @tag_present.setter
    def tag_present(self, tag_present: bool):
    ...
    @task_present.setter
    def task_present(self, task_present: bool):
    ...
    @property
    def time_entry_constraints_enabled(self) -> bool:
    ...
    def time_entry_constraints_enabled(self, time_entry_constraints_enabled: bool):
