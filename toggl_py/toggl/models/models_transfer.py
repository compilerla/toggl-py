...
class ModelsTransfer:
    ...
    def __init__(
        self,
        created_at: str = None,
        current_owner_accepted: bool = None,
        current_owner_answered_at: str = None,
        current_owner_id: int = None,
        finished_at: str = None,
        new_owner_accepted: bool = None,
        new_owner_answered_at: str = None,
        new_owner_id: int = None,
        organization_id: int = None,
        outcome_name: str = None,
        owner_transfer_id: int = None,
        requester_id: int = None,
        _configuration: Configuration = None,  # noqa: E501
    ):
        """
        ModelsTransfer - a model defined in Swagger
    ...
    @property
    def current_owner_accepted(self) -> bool:
    ...
    def current_owner_accepted(self, current_owner_accepted: bool):
    ...
    @property
    def current_owner_answered_at(self) -> str:
    ...
    def current_owner_answered_at(self, current_owner_answered_at: str):
    ...
    def current_owner_id(self, current_owner_id: int):
    ...
    @property
    def new_owner_accepted(self) -> bool:
    ...
    def new_owner_accepted(self, new_owner_accepted: bool):
    ...
    @property
    def new_owner_answered_at(self) -> str:
    ...
    def new_owner_answered_at(self, new_owner_answered_at: str):
    ...
    @outcome_name.setter
    def outcome_name(self, outcome_name: str):
    ...
    @property
    def owner_transfer_id(self) -> int:
    ...
    def owner_transfer_id(self, owner_transfer_id: int):
    ...
    @requester_id.setter
    def requester_id(self, requester_id: int):
