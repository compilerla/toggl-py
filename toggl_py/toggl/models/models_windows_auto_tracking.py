...
class ModelsWindowsAutoTracking:
    ...
    def __init__(
        ...
        parameters=None,
        project_id=None,
        skip_when_timer_is_running=None,
        start_without_confirmation=None,
        task_id=None,
        type=None,
        _configuration=None,
    ):  # noqa: E501
        """ModelsWindowsAutoTracking - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def skip_when_timer_is_running(self):
    ...
    def skip_when_timer_is_running(self, skip_when_timer_is_running):
    ...
    @property
    def start_without_confirmation(self):
    ...
    def start_without_confirmation(self, start_without_confirmation):
