...
class SubscriptionPayload:
    ...
    @property
    def contact_details(self) -> SubscriptionContactDetailRequest:
    ...
    def contact_details(self, contact_details: SubscriptionContactDetailRequest):
    ...
    @property
    def inc_terms_accepted(self) -> bool:
    ...
    def inc_terms_accepted(self, inc_terms_accepted: bool):
