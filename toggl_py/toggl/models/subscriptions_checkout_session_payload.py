...
class SubscriptionsCheckoutSessionPayload:
    ...
    def __init__(
        ...
        """
        SubscriptionsCheckoutSessionPayload - a model defined in Swagger
    ...
    @cancel_url.setter
    def cancel_url(self, cancel_url: str):
    ...
    @price_tag.setter
    def price_tag(self, price_tag: str):
    ...
    @referral.setter
    def referral(self, referral: str):
    ...
    def subdivision_id(self, subdivision_id: int):
