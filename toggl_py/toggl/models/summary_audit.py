...
class SummaryAudit:
    ...
    def __init__(
        self,
        group_filter: SummaryAuditGroupFilter = None,
        show_empty_groups: bool = None,
        show_tracked_groups: bool = None,
        _configuration: Configuration = None,  # noqa: E501
    ):
        """
        SummaryAudit - a model defined in Swagger

        Parameters:
          group_filter (SummaryAuditGroupFilter): Optional
          show_empty_groups (bool): Optional
          show_tracked_groups (bool): Optional
        """
    ...
    @property
    def group_filter(self) -> SummaryAuditGroupFilter:
    ...
    @group_filter.setter
    def group_filter(self, group_filter: SummaryAuditGroupFilter):
    ...
    @property
    def show_empty_groups(self) -> bool:
    ...
    def show_empty_groups(self, show_empty_groups: bool):
    ...
    @property
    def show_tracked_groups(self) -> bool:
    ...
    def show_tracked_groups(self, show_tracked_groups: bool):
