...
class SummaryAuditGroupFilter:
    ...
    def __init__(
        ...
        """
        SummaryAuditGroupFilter - a model defined in Swagger
    ...
    def max_amount_cents(self, max_amount_cents: int):
    ...
    def min_amount_cents(self, min_amount_cents: int):
