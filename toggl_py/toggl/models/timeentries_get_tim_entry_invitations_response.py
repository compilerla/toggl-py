...
class TimeentriesGetTimEntryInvitationsResponse:
    ...
    def __init__(
        ...
        time_entry=None,
        time_entry_invitation_id=None,
        workspace_id=None,
        _configuration=None,
    ):  # noqa: E501
        """TimeentriesGetTimEntryInvitationsResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def shared_by_user_id(self, shared_by_user_id):
    ...
    def shared_by_user_name(self, shared_by_user_name):
    ...
    @time_entry.setter
    def time_entry(self, time_entry):
    ...
    @property
    def time_entry_invitation_id(self):
    ...
    def time_entry_invitation_id(self, time_entry_invitation_id):
