...
class TimesheetsetupsAPITimesheetSetup:
    ...
    def __init__(
        ...
        end_date: str = None,
        errors: list[ModelsTimesheetSetupError] = None,
        id: int = None,
        member_id: int = None,
        ...
        """
        TimesheetsetupsAPITimesheetSetup - a model defined in Swagger

        Parameters:
          approver_id (int): Optional
          approver_name (str): Optional
          end_date (str): Optional
          errors (list[ModelsTimesheetSetupError]): Optional
          id (int): Optional
    ...
    @property
    def errors(self) -> list[ModelsTimesheetSetupError]:
    ...
    @errors.setter
    def errors(self, errors: list[ModelsTimesheetSetupError]):
