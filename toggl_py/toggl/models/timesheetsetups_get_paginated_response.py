...
class TimesheetsetupsGetPaginatedResponse:
    ...
    def __init__(
        self, data: list[TimesheetsetupsAPITimesheetSetup] = None, _configuration: Configuration = None  # noqa: E501
    ):
        """
        TimesheetsetupsGetPaginatedResponse - a model defined in Swagger

        Parameters:
          data (list[TimesheetsetupsAPITimesheetSetup]): Optional
        """
    ...
    @property
    def data(self) -> list[TimesheetsetupsAPITimesheetSetup]:
    ...
    @data.setter
    def data(self, data: list[TimesheetsetupsAPITimesheetSetup]):
